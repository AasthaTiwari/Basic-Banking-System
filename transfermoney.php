            ...
            <div class="row">
                ...
                ?>
                    <tr>
                        ...
                        <td><a href="transferto.php?id= <?php echo $rows['id'] ;?>"> <button type="button" class="btn" style="background-color : white; color:#1256c4;"><b>Transfer Now</b></button></a></td> 
                    </tr>
                <?php
                    }
                ?>
...
<footer><p>Made by &copy;Muskan Gupta</p>
